...
<head>
  ...
  <title><?= isset($title) ? $title . ' - NiceAdmin' : 'NiceAdmin' ?></title>
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg px-2 py-3">
            ...
            <li class="message-item">
              <a href="#">
                ...
                <div>
                  <h4>Maria Jua</h4>
                  <p>Velit asperiores et dhil tumhars</p>
                  <p>5 mins. ago</p>
                </div>
              </a>
            </li>
            ...
            <li class="message-item">
              <a href="#">
                ...
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et dhe tumhars</p>
                  <p>2 hours ago</p>
                </div>
              </a>
            </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-2">
            <li class="dropdown-header">
              <h6>Administrator</h6>
            </li>
            <li>
